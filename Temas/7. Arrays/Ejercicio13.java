...
public class Ejercicio13 {
  public static void main(String[] args) {
    ...
    opcionMinimo = Integer.parseInt(System.console().readLine()) == 1;

    for (int i = 0; i < 100; i++) {
      int numeroBuscando = opcionMinimo ? min : max;
      int num = nums[i];

      if (num == numeroBuscando) System.out.printf("**%d** ", num);
